...
const MeetingPlace = ({ onNextStep }: MeetingTitleInputProps) => {
  ...
  const onClickPlaceButton = (selectedPlace: PlaceTypes) => {
    ...
    setValue("si", selectedPlace.addressElements[0].longName)
    setValue("gu", selectedPlace.addressElements[1].longName)
    setValue("dong", selectedPlace.addressElements[2].longName)
